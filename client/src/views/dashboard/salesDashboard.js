   ...
   render() {
      const user = auth.getCurrentUser();
		if (user && user.role === 'Admin') {      
         return (
            <Fragment>
               ...
               <Row className="row-eq-height">
                  <Col sm="12" md="3">
                     <a href={"/admin/accounts/new-requests"}>
                        <MinimalStatisticsBG
                           cardBgColor="gradient-blackberry"
                           statistics="Customers"
                           text="View Registration Requests"
                           iconSide="right"
                        >
                        </MinimalStatisticsBG>
                     </a>
                  ...
                  <Col sm="12" md="3">
                     <a href={"/admin/accounts/add-new-customer/new"}>
                        <MinimalStatisticsBG
                           cardBgColor="gradient-ibiza-sunset"
                           statistics="Customers"
                           text="Add / Register New Customer"
                           iconSide="right"
                        >
                        </MinimalStatisticsBG>
                     </a>
                  ...
                  <Col sm="12" md="3">
                     <a href={"/admin/accounts/users-record"}>
                        <MinimalStatisticsBG
                           cardBgColor="gradient-green-teal"
                           statistics="Admin"
                           text="View All Administrative Users"
                           iconSide="right"
                        >
                        </MinimalStatisticsBG>
                     </a>
                  ...
                  <Col sm="12" md="3">
                     <a href={"/admin/accounts/add-new-user/new"}>
                        <MinimalStatisticsBG
                           cardBgColor="gradient-pomegranate"
                           statistics="Admin"
                           text="Add New Administrative User"
                           iconSide="right"
                        >
                        </MinimalStatisticsBG>
                     </a>
         ...
         if (user && user.role === 'Sales Representative') {
            return <Redirect to='/not-found'  />
         } else if (user && user.role === 'IT User') {
            return <Redirect to='/not-found'  />
         } else if (user && user.role === 'Report Analyst') {
            return <Redirect to='/analytics-dashboard'  />
