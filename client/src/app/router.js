...
// Admin #PG
const TestPage = lazy(() => import('../views/admin/test'));
const NewAccountRequest = lazy(() => import('../views/admin/accountManagement/accountRequest'));
const AddCustomerForm = lazy(() => import('../views/admin/accountManagement/addCustomerForm'));
const AddUserForm = lazy(() => import('../views/admin/accountManagement/addUserForm'));
const EditUserForm = lazy(() => import('../views/admin/accountManagement/editUserForm'));
const EditCustomerForm = lazy(() => import('../views/admin/accountManagement/editCustomerForm'));
		...
		return (
			...
			<BrowserRouter basename="/">
				<Switch>
					...
					<MainLayoutRoutes
						exact
						path="/admin/accounts/new-requests"
						render={(matchprops) => (
							<Suspense fallback={<Spinner />}>
								<NewAccountRequest {...matchprops} />
							</Suspense>
						)}
					/>
					...
					<MainLayoutRoutes
						exact
						path="/admin/accounts/add-new-customer/:id"
						render={(matchprops) => (
							<Suspense fallback={<Spinner />}>
								<AddCustomerForm {...matchprops} />
							</Suspense>
						)}
					/>
					...
					<MainLayoutRoutes
						exact
						path="/admin/accounts/users-record"
						render={(matchprops) => (
							<Suspense fallback={<Spinner />}>
								<UsersRecord {...matchprops} />
							</Suspense>
						)}
					/>
					...
					<MainLayoutRoutes
						exact
						path="/admin/accounts/add-new-user/:id"
						render={(matchprops) => (
							<Suspense fallback={<Spinner />}>
								<AddUserForm {...matchprops} />
							</Suspense>
						)}
					/>
					...
					<MainLayoutRoutes
						exact
						path="/admin/accounts/edit-user/:id"
						render={(matchprops) => (
							<Suspense fallback={<Spinner />}>
								<EditUserForm {...matchprops} />
							</Suspense>
						)}
					/>
					...
					<MainLayoutRoutes
						exact
						path="/admin/accounts/edit-customer/:id"
						render={(matchprops) => (
							<Suspense fallback={<Spinner />}>
								<EditCustomerForm {...matchprops} />
							</Suspense>
						)}
					/>
